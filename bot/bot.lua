...
function create_config( )
	io.write('\n\27[1;33mادخل ايدي حسابك لتصبح المطور 👇 \27[0;39;49m\n')
	local SUDO = tonumber(io.read())
if not tostring(SUDO):match('%d+') then
    SUDO = 60809019
  end
  	io.write('\n\27[1;33mارسل توكن بوتك الان 👇 \27[0;39;49m\n')
	local token = io.read()
	 	io.write('\n\27[1;33mادخل اسم البوت الذي تريده 👇 \27[0;39;49m\n')
...
file:close()
	...
	if token=="" then
print("◈￤ لم تقوم بوضع التوكن يجب عليك وضع التوكن في ملف البوت ليعمل السورس معك بنجاح\n")
